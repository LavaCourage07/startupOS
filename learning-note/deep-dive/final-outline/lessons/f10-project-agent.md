...
- 问题：Project Agent 和 RoleAgent 有何不同？
- 覆盖：`project-agent/project-context.ts`、`project-prompt.ts`
- 图解：ProjectContext -> 7 层 prompt -> PersistentAgent
- 验收：能解释 Frozen Snapshot 模式。
