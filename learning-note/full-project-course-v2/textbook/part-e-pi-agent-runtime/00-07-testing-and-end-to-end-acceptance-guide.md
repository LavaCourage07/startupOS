...
| 核心生命周期 | [packages/core/src/lib/integrations/pi-agent/core/__tests__/agent.test.ts 第 1 行](../../../../packages/core/src/lib/integrations/pi-agent/core/__tests__/agent.test.ts#L1)、[packages/core/src/lib/integrations/pi-agent/store.test.ts 第 1 行](../../../../packages/core/src/lib/integrations/pi-agent/store.test.ts#L1)、[packages/core/src/lib/integrations/pi-agent/__tests__/server-config.test.ts 第 1 行](../../../../packages/core/src/lib/integrations/pi-agent/__tests__/server-config.test.ts#L1) | 核心状态、UI 状态、凭证映射的不同合同 |
