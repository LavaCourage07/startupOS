...
exports.UpstreamResults = void 0;
class UpstreamResults {
     ...
     */
    writeUpstreamOutput(agentId, agentName, output) {
     ...
     */
    readUpstreamOutput(agentId, agentName) {
        const outputKey = `upstream$${agentId}$output`;
     ...
     * 获取上游完成状态摘要
     */
    getUpstreamMetadatas() {
        const allEntries = this.blackboard.getEntries().filter((entry) => entry.key.startsWith("meta$upstream$"));
...
exports.UpstreamResults = UpstreamResults;
