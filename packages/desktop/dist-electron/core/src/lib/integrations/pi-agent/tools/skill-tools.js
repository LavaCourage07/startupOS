...
// 工具: 查询可用技能
// ============================================================================
const ListSkillsParamsSchema = typebox_1.Type.Object({}, {
...
const ListSkillsTool = {
    ...
    async execute(toolCallId, params, signal, onUpdate) {
        ...
        try {
            ...
            const userSkillsDir = path_1.default.resolve((0, paths_1.getDataRoot)(), "skills");
            const result = (0, skills_1.loadSkills)({
                cwd: (0, paths_1.getDataRoot)(),
                includeDefaults: false,
                skillPaths: (0, fs_1.existsSync)(userSkillsDir) ? [userSkillsDir] : [],
            });
...
// 工具: Skill 元工具
// ============================================================================
const SkillParamsSchema = typebox_1.Type.Object({
    skill: typebox_1.Type.String({ description: "技能名称或代码（例如：'commit', 'search-and-install-skill'）" }),
    args: typebox_1.Type.Optional(typebox_1.Type.String({ description: "传递给技能的参数（可选）" })),
});
/**
 * Skill 元工具
 *
...
const SkillTool = {
    ...
    async execute(toolCallId, params, signal, onUpdate) {
        ...
        try {
            ...
            const skillUserSkillsDir = path_1.default.resolve((0, paths_1.getDataRoot)(), "skills");
            const result = (0, skills_1.loadSkills)({
                cwd: (0, paths_1.getDataRoot)(),
                includeDefaults: false,
                skillPaths: (0, fs_1.existsSync)(skillUserSkillsDir) ? [skillUserSkillsDir] : [],
            });
            const { skills } = result;
            // 查找技能（按 name 或 code 匹配）
            const targetSkill = skills.find(s => s.name === skillNameOrCode || s.code === skillNameOrCode);
            if (!targetSkill) {
            ...
            if (!(0, fs_1.existsSync)(skillFilePath)) {
                return {
                    content: [{
                            type: "text",
                            text: JSON.stringify({
            ...
            let skillContent = (0, fs_1.readFileSync)(skillFilePath, "utf-8");
            const originalBaseDir = targetSkill.baseDir;
            const toolContext = (0, context_1.getToolContext)();
            const workingDir = toolContext.workingDirectory || (0, paths_1.getDataRoot)();
            ...
            const skillsDir = path_1.default.join(workingDir, ".skills");
            const skillLinkPath = path_1.default.join(skillsDir, skillCode);
            const resolvedBaseDir = (0, fs_1.existsSync)(skillLinkPath) ? skillLinkPath : originalBaseDir;
            // 创建持久化软链接
            try {
                if (!(0, fs_1.existsSync)(skillsDir)) {
                    (0, fs_1.mkdirSync)(skillsDir, { recursive: true });
                }
                if (!(0, fs_1.existsSync)(skillLinkPath)) {
                    (0, fs_1.symlinkSync)(originalBaseDir, skillLinkPath, "dir");
            ...
            const outputDir = path_1.default.join(workingDir, "output", skillCode);
